...
<table width="1250" border="0">
  <tr>
    <td width="46"><div align="center"><a href="?id=A">A</a></div></td>
    <td width="46"><div align="center"><a href="?id=B">B</a></div></td>
    <td width="46"><div align="center"><a href="?id=C">C</a></div></td>
    <td width="46"><div align="center"><a href="?id=D">D</a></div></td>
    <td width="46"><div align="center"><a href="?id=E">E</a></div></td>
    <td width="46"><div align="center"><a href="?id=F">F</a></div></td>
    <td width="46"><div align="center"><a href="?id=G">G</a></div></td>
    <td width="46"><div align="center"><a href="?id=H">H</a></div></td>
    <td width="46"><div align="center"><a href="?id=I">I</a></div></td>
    <td width="46"><div align="center"><a href="?id=J">J</a></div></td>
    <td width="46"><div align="center"><a href="?id=K">K</a></div></td>
    <td width="46"><div align="center"><a href="?id=L">L</a></div></td>
    <td width="46"><div align="center"><a href="?id=M">M</a></div></td>
    <td width="46"><div align="center"><a href="?id=N">N</a></div></td>
    <td width="46"><div align="center"><a href="?id=O">O</a></div></td>
    <td width="46"><div align="center"><a href="?id=P">P</a></div></td>
    <td width="46"><div align="center"><a href="?id=Q">Q</a></div></td>
    <td width="46"><div align="center"><a href="?id=R">R</a></div></td>
    <td width="46"><div align="center"><a href="?id=S">S</a></div></td>
    <td width="46"><div align="center"><a href="?id=T">T</a></div></td>
    <td width="46"><div align="center"><a href="?id=U">U</a></div></td>
    <td width="46"><div align="center"><a href="?id=V">V</a></div></td>
    <td width="46"><div align="center"><a href="?id=W">W</a></div></td>
    <td width="46"><div align="center"><a href="?id=X">X</a></div></td>
    <td width="46"><div align="center"><a href="?id=Y">Y</a></div></td>
    <td width="46"><div align="center"><a href="?id=Z">Z</a></div></td>  
  </tr>
</table>
...
<?php
$size=10;
$countquery = $db->query("SELECT COUNT(info.ID) FROM info,cc WHERE cc.id=info.ID AND info.SUBJECT LIKE '".$id."%'");
...
<?php
$sql="SELECT info.ID, info.SUBJECT,info.BOOK,info.LINK,info.AUTHOR,info.SLIDES,info.SCHOOL,info.PROFESSOR,cc.likes,cc.unlikes FROM info,cc WHERE cc.id=info.ID AND info.SUBJECT LIKE '".$id."%' ORDER BY likes DESC LIMIT $jump,$size";
